...
dock:
	...
	python3 ./build/dock.py petuh ./petuh/Dockerfile 0.16.100
	python3 ./build/dock.py petuh-llm ./petuh-llm/Dockerfile 0.16.100
	python3 ./build/dock.py petuh-data ./petuh-data/Dockerfile 0.16.100
