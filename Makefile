...
dock:
	...
	python3 ./build/dock.py petuh ./petuh/Dockerfile 0.17.103
	python3 ./build/dock.py petuh-llm ./petuh-llm/Dockerfile 0.17.103
	python3 ./build/dock.py petuh-data ./petuh-data/Dockerfile 0.17.103
